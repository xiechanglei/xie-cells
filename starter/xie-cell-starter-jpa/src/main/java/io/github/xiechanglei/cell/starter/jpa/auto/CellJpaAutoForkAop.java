...
import io.github.xiechanglei.cell.starter.jpa.auto.task.FindAllJpaForkTask;
...
public class CellJpaAutoForkAop {
    ...
    private final FindAllJpaForkTask findAllTask;
     ...
     * @return 查询到的实体对象或方法自定义的返回值
     */
    @Around("@annotation(io.github.xiechanglei.cell.starter.jpa.auto.task.FindAll)")
    public Object aroundFindAll(ProceedingJoinPoint pjp) throws Throwable {
        return findAllTask.service(pjp);
    }
}
